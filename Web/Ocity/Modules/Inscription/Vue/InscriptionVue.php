...
class InscriptionVue {
	...
	<div id='SumBatiments'>
		...
		<div class='ContenuSite'>
			...
			<label>Conf. du mot de passe</label>
			...
			<select name="pays" required>
				...
				echo "<option ";
				if ($value['nom_fr_fr'] == 'France')
				    echo "selected ";
				echo "value='" . $value['id'] . "'>" . $value['nom_fr_fr'] . "--" . $value['nom_en_gb'] . "</option>";
			    }
			    ?>
			</select><br/>
			<input type="submit" value="Je passe à l'étape suivante"/><br/>
	...
	<div id='SumBatiments'>
		...
		<div class='ContenuSite'>
			...
			?>
			<input type="submit" value="Je finis mon inscription" class="cache_div" id="inp_sub"/>
		    </form>
		    <script>
    ...
    function inscrOk() {
	Confirm::display("Votre inscription s'est terminée avec succès !");
    }
